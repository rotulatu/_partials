...
<script src="https://www.insegnefaidate.it/js/jquery.fontselect.js?asd"></script>        
<script src="https://www.insegnefaidate.it/3dNow/build/three.min.js"></script>
<script src="https://www.insegnefaidate.it/3dNow/js/controls/OrbitControls.js"></script>
<script src="https://www.insegnefaidate.it/3dNow/js/loaders/SVGLoader.js"></script>
<script src="https://www.insegnefaidate.it/3dNow/js/renderers/SVGRenderer.js"></script>
<script src="https://www.insegnefaidate.it/3dNow/js/renderers/Projector.js"></script>
    ...
    <div id="svgSettings" class="">
		...
		<div class="form-inline">
			...
			<div id="depth" class="form-group col-lg-12">
				<label for="myGross">Grosor mm</label> 
			...
			<div id="colorMap" class="row attribute_list" style="display: none;">
        	    ...
        	    <ul class="color_to_pick_list" class="clearfix">
        	        <li id="Pantone" class="attribute_radio pointer" name="" value="" style="display:none">
        	            <a href="https://www.insegnefaidate.it/3dNow/color-maps/pantone.html"  name="Pantone" class="color_pick2 iframe" title="Pantone" onclick=""> <img style="text-align:center; margin: 0 auto;" src="https://cdn3.rotulatumismo.com/img/co/pantone.png" alt="Pantone" title="Pantone"></a>
        	        </li>
        	        <li id="Ncs" class="attribute_radio pointer" name="" value="" style="display:none">
        	            <a href="https://www.insegnefaidate.it/3dNow/color-maps/ncs.html"  name="Ncs" class="color_pick2 iframe" title="Ncs" onclick=""> <img style="text-align:center; margin: 0 auto;" src="https://cdn3.rotulatumismo.com/img/co/ncs.png" alt="Ncs" title="Ncs"></a>
        	        </li>
        	        <li  id="Ral" class="attribute_radio pointer" name="" value="" style="display:none">
        	            <a href="https://www.insegnefaidate.it/3dNow/color-maps/ral.html"  name="Ral" class="color_pick2 iframe" title="Ral" onclick=""> <img style="text-align:center; margin: 0 auto;" src="https://cdn3.rotulatumismo.com/img/co/ral.png" alt="Ral" title="Ral"></a>
        	        </li>
        	        <li id="Oracal" class="attribute_radio pointer" name="" value="" style="display:none">
        	            <a href="https://www.insegnefaidate.it/3dNow/color-maps/oracal.html"  name="oracal" class="color_pick2 iframe" title="Oracal" onclick=""> <img style="text-align:center; margin: 0 auto;" src="https://cdn3.rotulatumismo.com/img/co/oracal.png" alt="Oracal" title="Oracal"></a>
        	        </li>
					<li id="Colores" class="attribute_radio pointer" name="" value="" style="display:none">
        	            <a href="https://www.insegnefaidate.it/3dNow/color-maps/Colores.html"  name="Colores" class="color_pick2 iframe" title="Colores" onclick=""> <img style="text-align:center; margin: 0 auto;" src="https://www.insegnefaidate.it/img/co/colores.png" alt="Colores" title="Colores"></a>
        	        </li>
				</ul>
...
var url = "https://www.insegnefaidate.it/3dNow/";
var cubeBox = 'https://www.insegnefaidate.it/3dNow/textures/cube/skyboxsun25deg/';
var texturePath = "https://www.insegnefaidate.it/3dNow/texture/";

var urlIcon = "https://www.insegnefaidate.it/3dNow/icons/";
...
<script src="https://www.insegnefaidate.it/3dNow/prd/{$product->price_square}.js?asd"></script>
<script src="https://www.insegnefaidate.it/3dNow/build/threed.min.js"></script>
