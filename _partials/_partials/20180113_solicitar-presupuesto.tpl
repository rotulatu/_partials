		...
		<div class="adaptResponsive">
			...
			<div class="formMoreInfo" style="display: none;">
				...
				<form data-parsley-validate class="form-solid-dark" name='formulario' id="form-more-information" method='post' action='{$base_dir}includes/data/enviar-form-solicitar-presupuesto.php' target='_self' enctype="multipart/form-data">
