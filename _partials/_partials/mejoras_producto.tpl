...
$(function(){
       ...
       var estado = 0;
       $('#pedirinfomostrar2').click(function(){
       	if (estado == 0){
		...
		<div class="adaptResponsive">
			...
			<div id="pedirinfomostrar2" style="float:right;"></div>
...
<body>
				...
				<form data-parsley-validate class="form-solid-dark" name='formulario' id="form-more-information" method='post' action='{$base_dir_ssl}includes/data/enviar-form-solicitar-presupuesto.php' target='_self' enctype="multipart/form-data">
					...
					<textarea name="mensaje" cols="35" rows="10" id="mensaje" data-parsley-required="true" placeholder="Escribe aquí lo que necesitas cambiar" class="areaFormMoreInfo"></textarea>
